...
public class JavaToJson {
	...
	private void jsonToJava()
	{
		...
		try {
			temp = objectMapper.readValue(new File("/home/tszhin/Desktop/stops.json"), new TypeReference<List<temp_stop>>(){});
		...
		try {
			myObjects_Arrets = objectMapper.readValue(new File("/home/tszhin/Desktop/arrets.json"), new TypeReference<List<Arret>>(){});
